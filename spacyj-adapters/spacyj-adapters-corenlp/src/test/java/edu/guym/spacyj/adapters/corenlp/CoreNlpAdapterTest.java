...
public class CoreNlpAdapterTest {
    ...
    public void createAndVerifyShortSentence() {
        ...
        List<TokenData> expectedWords = Arrays.asList(
                ...
                TokenData.builder().setText("dog").setBefore(" ").setAfter(" ").setIndex(1).setBeginOffset(3).setEndOffset(6).setLemma("dog").setTag("NN").setPos("NOUN").setHead(3).setDependency("nsubj").build(),
                TokenData.builder().setText("is").setBefore(" ").setAfter(" ").setIndex(2).setBeginOffset(7).setEndOffset(9).setLemma("be").setTag("VBZ").setPos("VERB").setHead(3).setDependency("cop").build(),
                TokenData.builder().setText("hungry").setBefore(" ").setAfter("").setIndex(3).setBeginOffset(10).setEndOffset(16).setLemma("hungry").setTag("JJ").setPos("ADJ").setHead(-1).setDependency("root").build(),
    ...
    public void createAndVerifyLongSentence() {
        ...
        List<TokenData> expectedWords = Arrays.asList(
                ...
                TokenData.builder().setText("moon").setBefore(" ").setAfter(" ").setIndex(1).setBeginOffset(4).setEndOffset(8).setLemma("moon").setTag("NN").setPos("NOUN").setHead(4).setDependency("nsubj").build(),
                TokenData.builder().setText("is").setBefore(" ").setAfter(" ").setIndex(2).setBeginOffset(9).setEndOffset(11).setLemma("be").setTag("VBZ").setPos("VERB").setHead(4).setDependency("cop").build(),
                TokenData.builder().setText("very").setBefore(" ").setAfter(" ").setIndex(3).setBeginOffset(12).setEndOffset(16).setLemma("very").setTag("RB").setPos("ADV").setHead(4).setDependency("advmod").build(),
                TokenData.builder().setText("bright").setBefore(" ").setAfter("").setIndex(4).setBeginOffset(17).setEndOffset(23).setLemma("bright").setTag("JJ").setPos("ADJ").setHead(-1).setDependency("root").build(),
                ...
                TokenData.builder().setText("I").setBefore(" ").setAfter(" ").setIndex(6).setBeginOffset(25).setEndOffset(26).setLemma("I").setTag("PRP").setPos("PRON").setHead(8).setDependency("nsubj").build(),
                TokenData.builder().setText("can").setBefore(" ").setAfter(" ").setIndex(7).setBeginOffset(27).setEndOffset(30).setLemma("can").setTag("MD").setPos("VERB").setHead(8).setDependency("aux").build(),
                TokenData.builder().setText("read").setBefore(" ").setAfter(" ").setIndex(8).setBeginOffset(31).setEndOffset(35).setLemma("read").setTag("VB").setPos("VERB").setHead(4).setDependency("parataxis").build(),
                TokenData.builder().setText("a").setBefore(" ").setAfter(" ").setIndex(9).setBeginOffset(36).setEndOffset(37).setLemma("a").setTag("DT").setPos("DET").setHead(10).setDependency("det").build(),
                TokenData.builder().setText("book").setBefore(" ").setAfter(" ").setIndex(10).setBeginOffset(38).setEndOffset(42).setLemma("book").setTag("NN").setPos("NOUN").setHead(8).setDependency("obj").build(),
                TokenData.builder().setText("by").setBefore(" ").setAfter(" ").setIndex(11).setBeginOffset(43).setEndOffset(45).setLemma("by").setTag("IN").setPos("ADP").setHead(12).setDependency("case").build(),
